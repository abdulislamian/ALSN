...
namespace ALSN.Infrastructure.Migrations
{
    ...
    [Migration("20231212030852_AddChatsPaymentSErviceCategoryPaymentDetail_tbl")]
    partial class AddChatsPaymentSErviceCategoryPaymentDetail_tbl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ALSN.Domain.Entities.Guest.Payment.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ALSN.Domain.Entities.Guest.Payment.PaymentDetails", b =>
                {
            ...
            modelBuilder.Entity("ALSN.Domain.Entities.Guest.Translation.Chats", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ALSN.Domain.Entities.User.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "cc21288e-b706-4de1-aa8b-e99d2368ffd1",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "6c9a6dbe-adf3-4a4d-83ca-f06fe1937f97",
                            ...
                            SecurityStamp = "2d915ae3-deeb-4a9b-8cd3-c08b9793a4c3",
            ...
            modelBuilder.Entity("ALSN.Domain.Entities.Guest.Guest", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "c4b55440-4620-4ed5-8ba9-308d5ba7991e",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a2880a88-b50e-4cf8-8c0f-33dbf15572f8",
                            ContactNo = "03149276066",
                            ...
                            PasswordHash = "hashed_password_here",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "8d99ea47-9d70-44b1-ba1f-1a5ddeb2d35b",
                            TwoFactorEnabled = false
                        });
                });
            ...
            modelBuilder.Entity("ALSN.Domain.Entities.TranslationOffice.TranslOffice", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "49e6245a-4d44-4610-9a40-3ba440abe190",
                            ContactNo = "03149276066",
                            ...
                            PasswordHash = "hashed_password_here",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "2d838714-bfb9-45f2-a935-e73790f1aec9",
                            TwoFactorEnabled = false,
                            City = "Peshawar",
                            CompOwnerName = "ABC",
            ...
            modelBuilder.Entity("ALSN.Domain.Entities.Translator.Translators", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "9fbb9a41-e39c-45f8-a06c-00fd5fca150c",
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9565e631-1ca6-42b4-a6b1-696a7bd89a9c",
                            ContactNo = "03149276066",
                            ...
                            PasswordHash = "hashed_password_here",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "c0145a1b-3e65-41e4-9a29-f9dbda0978f1",
                            TwoFactorEnabled = false,
            ...
            modelBuilder.Entity("ALSN.Domain.Entities.Guest.Payment.Payment", b =>
                {
                    ...
                    b.HasOne("ALSN.Domain.Entities.TranslationOffice.DeliveryService.ServiceCategory", "serviceCategory")
                        .WithMany()
                        .HasForeignKey("ServiceTypeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("ALSN.Domain.Entities.TranslationOffice.TranslOffice", "translationOffice")
                        .WithMany()
            ...
            modelBuilder.Entity("ALSN.Domain.Entities.Guest.Payment.PaymentDetails", b =>
                {
                    b.HasOne("ALSN.Domain.Entities.Guest.Payment.Payment", "Payment")
